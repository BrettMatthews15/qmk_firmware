 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSPO,  LCTL_T(KC_Z),   KC_X,    KC_C,    KC_V,    KC_B, KC_HOME,  TG(_GAME),  KC_N,    KC_M,    KC_COMM, KC_DOT,  RCTL_T(KC_SLSH),  KC_RAPC, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______,  KC_LEFT, KC_DOWN, KC_RIGHT, _______,                 XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, \
